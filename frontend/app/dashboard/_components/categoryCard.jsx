...
function CategoryCard({ emoji, title, quantity, limit, spent, remaining }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-2 md:py-4 md:px-6 bg-white border border-softGray rounded-md drop-shadow w-auto cursor-pointer hover:drop-shadow-lg transition duration-150 ease-out hover:ease-in">
