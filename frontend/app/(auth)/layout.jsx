        ...
        <section>
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                <section className="relative flex h-32 items-center text-center bg-primary lg:h-full lg:col-span-8">
                    <Image src={bgAuth} alt="Background Auth Layout" className="absolute inset-0 h-full w-full object-cover opacity-30" priority={true} />
                    ...
                    <div className="hidden lg:relative lg:block lg:px-36 w-full">
                        ...
                        <p className="mt-4 leading-relaxed text-white/90">
                            Seu aliado para gerenciar e otimizar suas finanças de forma simples e eficiente.
                        </p>
                    </div>
                </section>

                <main
                    className="flex items-center justify-center px-8 py-8 sm:px-12 lg:px-16 lg:py-12 lg:col-span-4"
                >
